...
YT_API_KEY = getenv("YT_API_KEY", "xbit_yqLxTTQHldjQv1dlj_i0w5-v5kVy3OaA", None ) ## Your API key like: xbit_10000000xx0233 Get from  https://t.me/tgmusic_apibot
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/bhaisoumu/Xbit",
)
